...
function NativeControls() {
    ...
    this.leftNavBarButtonCallback = null;
    this.rightNavBarButtonCallback = null;
}
...
*/
NativeControls.prototype.setupLeftNavButton = function(title, image, onselect)
{
    this.leftNavBarButtonCallback = onselect;
    Cordova.exec("NativeControls.setupLeftNavButton", title || "", image || "");
};
 ...
 */
NativeControls.prototype.leftNavButtonTapped = function()
{
    if(typeof(this.leftNavBarButtonCallback) === "function")
        this.leftNavBarButtonCallback()
};

/**
 * Assign either title or image to the right navigation bar button, and assign the tap callback
*/
NativeControls.prototype.setupRightNavButton = function(title, image, onselect)
{
    this.rightNavBarButtonCallback = onselect;
    Cordova.exec("NativeControls.setupRightNavButton", title || "", image || "", onselect);
};
 ...
 * Internal function called by the plugin
 */
NativeControls.prototype.rightNavButtonTapped = function()
{
    if(typeof(this.rightNavBarButtonCallback) === "function")
        this.rightNavBarButtonCallback()
