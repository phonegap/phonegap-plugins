...
5. While in AlarmReceiver.java, correct the references to your application at the import lines, and also at line 84. This will enable your notification to launch your app when tapped.
6. Update your res/xml/plugins.xml file with the following line:

        <plugin name="LocalNotification" value="com.phonegap.plugin.localnotification.LocalNotification" />

7. Add the following fragment in the AndroidManifest.xml inside the <application> tag:
