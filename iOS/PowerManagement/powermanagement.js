...
;( function ( cordova ) {
  ...
  */
  PowerManagement.prototype.acquire = function powerManagerAcquireWakeLock ( successCallback, failureCallback ) {
  ...
  */
  PowerManagement.prototype.release = function powerManagerReleaseWakeLock ( successCallback, failureCallback ) {
  ...
  * @param errorCallback function to be called when there was a problem with acquiring the wake-lock
  */
  PowerManagement.prototype.partial = function powerManagerPartialWakeLock ( successCallback, failureCallback ) {
    cordova.exec( successCallback, failureCallback, 'PowerManagement', 'acquire', [ true ] );
  };

  cordova.addConstructor( function PowerManagementConstructor () {
    if ( typeof window.plugins === 'undefined' ) { window.plugins = {}; }
    if ( typeof window.plugins.PowerManagement === 'undefined' ) { window.plugins.PowerManagement = new PowerManagement(); }
  });
